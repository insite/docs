---
description: Safe Exam Browser is a web browser environment to carry out e-assessments safely.
---
...
*Please Note:  Safe Exam Browser is an open source software that was not developed by InSite Information Systems. Support is familiar with its basic functionality and we can answer some questions, but for most requests we advise using the Safe Exam Browser help documentation found here [https://safeexambrowser.org/windows/win_usermanual_en.html](https://safeexambrowser.org/windows/win_usermanual_en.html)*
