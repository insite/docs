---
description: >-
  How the system analyzes an assessment attempt automatically and how to
...
When doing a **Force Complete** for an uncompleted Assessment Attempt, an Administrator can click the Analyze button to instruct the system to go through the analyze process.
