---
description: Admins can perform advanced searches in the Questions tab by using advanced search syntax.
---
...
The results will bring up all questions in the bank with the entered **parameter:value**.
