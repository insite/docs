...
In the **Upload Shift iQ Markdown** field click on the **Folder** icon (<i class="fa-folder-open">:folder-open:</i>) and select the **Markdown** file you want to upload. The file format can be a Text file (_.txt) or a Markdown file (_.md).
