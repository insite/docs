---
description: When Sections as Tabs is enabled and Tab Navigation is disabled, you can set timers for individual sections (tabs) within the assessment form.
---
...
<span style="color:black">**Please Note:** When **Enable Timer for All Tabs** is selected, then you are not able to add Accommodations for an exam.</span>
