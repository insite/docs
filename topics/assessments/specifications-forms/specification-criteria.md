---
description: Once the Specification has been created, you can apply filtering criteria to refine which questions are displayed on the exam Form.
---
...
* Configure **Question Item Limit**. The maximum number of question items allowed on an exam form from this question set.
* Click on **Save**
