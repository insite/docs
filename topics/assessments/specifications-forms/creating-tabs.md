---
description: "Please note: Tabs can only be enabled if the Specification Type is set to Static. Tabs cannot be enabled if the Specification Type is set to Dynamic.*"
---
...
1. **Allow Tab Navigation (Optional)**
...
1. **Add the Title for each Tab**
 The Administrator needs to set the **Title** for each **Tab** that is appearing on the Assessment Form. If a **Title** is not added, it will display as "Untitled"
