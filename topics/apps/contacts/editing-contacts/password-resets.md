...
From the Admin Home page, search for the user you would like to reset the password for ([**Searching Contacts**](/ui/help/apps/portal/contacts/searching-contacts)). 
