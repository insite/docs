---
description: If desired, site pages can be configured to have a Submit a Request button below the other content.
---

# Customized Help Requests

If desired, site pages can be configured to have a **Submit a Request** button below the other content. Admins can also customize who receives the help request that is triggered with this button, if desired.
