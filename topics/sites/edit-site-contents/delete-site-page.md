---
description: Select the Page or Folder you want to Delete.
---
...
Select the "**Delete this page and all its contents and contained pages**" checkbox and click the **Delete** button to completely delete the Folder/Page.
