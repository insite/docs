---
description: In the Downstream tab of the Relationships ribbon, select the relationships you want to remove and click the Delete icon.
---

# Remove downstream relationships
