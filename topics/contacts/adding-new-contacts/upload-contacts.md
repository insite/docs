---
description: This feature is generally used to upload multiple NEW contacts records into your Contact toolkit.
---
...
1. Go into **Contacts** toolkit and below the People counter, select **Upload Contact People**.

2. Select the **CSV UTF-8 (comma delimited) (.csv)** file with the contact details of the users you would like to add.
     Your upload file must be a spreadsheet saved as a **CSV UTF-8 (comma delimited) (.csv)** file.

3. *Optional:* the contacts you are uploading can all be attached to a specific group if desired. Select an existing group or input the name of a new group.
