...
1. Update your account information (_Accounts panel_)
2. Select Employer (_Employer panel_)
3. Choose Payment option - Seat selection (_Class Registration panel_)
4. Enter Payment info (_Payment panel_)
5. Confirm (_Confirm Details & Payment panel_)
