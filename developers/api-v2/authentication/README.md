...
The API uses personal access tokens to authenticate requests. By default, tokens expire after 24 hours — if you need a longer-lived token, see [How to generate an access token with a long lifetime](how-to-generate-an-access-token-with-a-long-lifetime.md).
